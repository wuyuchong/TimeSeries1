...
# 1. Introduction {-}
Each stochastic process  implies a theoretical structure of the autocorrelation function (ACF). A particular dataset is a *realization* of some specific stochastic process. Hence, by analyzing at a sample ACF, one can approximate the underlying stochastic process, and find the proper model to estimate it, thereby being able to make forecasts. However, in order to be capable of matching a sample ACF with a theoretical one, one must first know the properties of the theoretical stochastic process and thereby it's ACF. Hence, we need to have a catalogue of theoretical ACF:s. The purpose of this paper is to review some MA(q), AR(p) and ARMA(p,q) processes, to create such a catalogue.

Each section in the paper starts with a general discussion about the process in question, followed by a simulation excercise where we generate a sample based on the process in question. In that way, we can study the correlogram of the process. One important aspect of the discussion is whether a particular process is covariance stationary or not, since this has major implications for how to work with the process. The sample size in the simulations is set to 5000 (if nothing else is stated), but the plots only runs up to 500. 

The paper is structured as follows. In section 2, the concept of covariance stationary is defined, which will be a point of reference in most of the following discussions. Section 3 and 4 discuss the MA(1) and MA(2) processes respectively, and section 5 and 6 discuss the AR(1) and AR(2). Section 7 covers the ARMA() process, and section 8 concludes.
...
AR(1): $$Y_t = \phi_1(\phi_1Y_{t-2}+e_{t-1}) + e_t \\ Y_t = \phi_1^2(\phi_1Y_{t-3}+e_{t-2})+\phi_1e_{t-1} + e_t \\ Y_t = \phi_1^3(\phi_1Y_{t-4}+e_{t-3})+\phi_1e_{t-2}+\phi_1e_{t-1} + e_t \\ etc.$$
...
The true first autocorrelation is 0.778, an the second is 0.644. THIS DOES NOT MATCH THE CORRELOGRAM!!
...
$$\begin{array}{l}{Y_{t}=e_{t}-\theta_{1} e_{t-1}-\theta_{2} e_{t-2}} \\ {Y_{t-2}=e_{t-2}-\theta_{1} e_{t-3}-\theta_{2} e_{t-4}}\end{array}$$
...
We merge AR with MA to get ARMA

AR-part: $\phi(B)Y_{t}$

MA-part: $\phi(B)Y_{t}$

ARMA-model: $\phi(B)Y_{t}$ = $\phi(B)Y_{t}$
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/1}
    \end{minipage} \\
    \hline
    $\theta{_1} = -0.45$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/2}
    \end{minipage} \\
    \hline
    $\theta{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/3}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/4}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 1$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/5}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 2$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/6}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/7}
    \end{minipage} \\
    \hline
    $\theta{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/10}
    \end{minipage} \\
    \hline
    $\theta{_1} = 0.8$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/13}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/8}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/11}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 0.8$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/14}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/9}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/12}
    \end{minipage} \\
    \\ 
    \hline
    $\theta{_1} = 0.8$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/15}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/16}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = -0.95$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/17}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = -0.75$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/18}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/19}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.75$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/20}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.95$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/21}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 1$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/22}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/23}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/26}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.7$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/28}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/24}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/27}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.7$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/30}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/25}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0$
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/31}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/32}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.8$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/34}
    \end{minipage} \\
    \\ 
    \hline
    $\phi{_1} = 0.9$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/36}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{ | l | c | }
    ...
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/33}
    \end{minipage} \\
    \\ 
    \hline
    $0.8$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/35}
    \end{minipage} \\
    \\ 
    \hline
    $0.9$
    &
    \begin{minipage}{.3\textwidth}
      \includegraphics[height=150mm]{figure/37}
    \end{minipage} \\
    \\ 
    \hline
  \end{tabular}
